@extends('integra.defaultintegra', 
	['sideRegionVars'=>$sideRegionVars, 'navbarVars'=>$navbarVars, 'permIntegraManage'=>$permIntegraManage, 'statusDesc' => $integra->getStatusDesc(), 
	 'titleDetail'=>  Lang::get('content.panel') .' '. $integra->getName() .' - '. Lang::get('content.events'), 'customButtons' =>
...
{[ Form::hidden('trans-date-picker-SelectTime', Lang::get('content.datePickerSelectTime',['id'=>'trans-date-picker-SelectTime'])) ]}
        ...
        <div class="row">
            <div class="col-sm-12 top-buffer">
                <table class="table table-hover tabela-wynik" data-toggle="table" >
                    <thead class="filter">
                        <tr class="tabela-head">
                            {[ Form::hidden('controlList', $integra->getId(), ['id'=>'controlList']) ]}
                            ...
                            <th data-field="type" style="min-width: 30%;">
                                <select class="form-control" name="type" id="type" placeholder="{[Lang::get('content.list-event')]}">
                ...
                <tr><th colspan="7" class="clear-tab">
                    ...
                    <div id="eventcomment" class="row collapse">
						...
						<div class="switch-toggle switch-3 switch-candy">
                            ...
                            <tr id="btnNext"><td colspan="8" class="tabela-wiecej text-center"><button class="fa fa-lg fa-angle-down btn-more btn-block" id="btnNext" name="btnNext" style="" type="submit" value="Starsze"></td></tr>
                            </table>
        ...
        <script src="/js/event-integra.2b034727.js"></script>
        @stop
		@section('stylesheets')
